...
import {
  ...
  BookOpen, TrendingUp, Star, BarChart2, ChevronRight, GraduationCap
} from "lucide-react";
...
export default function StudentDashboard() {
  ...
  const avgProgress = totalCourses > 0
    ? Math.round(myCourses.reduce((s: number, e: any) => s + (e.progress ?? 0), 0) / totalCourses) : 0;
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <div className="mt-auto">
            ...
            <div className="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden mb-4">
              <div className={`h-full rounded-full transition-all duration-1000 ${isFinished ? 'bg-green-500' : 'bg-indigo-600'}`}
      ...
      <aside className="w-60 bg-white border-r border-gray-100 flex flex-col fixed top-0 left-0 h-screen z-30">
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          <div className="px-3 py-2 mb-2">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Student Menu</span>
          </div>
          ...
          <Link href="/student/analytics" className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold text-sm text-gray-500 hover:bg-gray-50 transition-all">
            <BarChart2 size={17} /> My Analytics
          </Link>
        </nav>
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-green-100 text-green-600">👨‍🎓 Student</span>
            </div>
          </div>
        ...
        <main className="flex-1 p-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[
              ...
              { label: "In Progress", value: inProgressCourses, sub: "Ongoing", icon: <TrendingUp size={18} />, bg: "bg-amber-50", text: "text-amber-600" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
            ...
            <Link href="/student/analytics"
              className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl p-6 flex flex-col justify-between text-white hover:shadow-xl hover:scale-[1.02] transition-all duration-300 group">
              <div>
